const GUIDE_ID = 'a11y-v-reading-guide-line';
let listening = false;
...
export function startReadingGuide() {
    ...
    guide.style.cssText = `
        ...
        background: rgba(37,99,235,0.6); box-shadow: 0 0 6px rgba(37,99,235,0.6);
        pointer-events: none; z-index: 99997; transition: top 50ms linear;
    `;
